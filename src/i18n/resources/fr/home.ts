...
export const translation: TranslationHome<"fr"> = {
    "Home": {
        ...
        "heroParagraph": "Récital Production c’est une touche d’élégance musicale pour sublimer vos événements en région bordelaise, Gironde, et tout le Sud-Ouest de la France.",
